...
var clearingPoProductDetails = mongoose.Schema({

    orderNumber: { type: String, default: null },
    clearingPoId: { type: Schema.Types.ObjectId, ref: ' clearingPo' },
...
}, { collection: 'clearingPoProductDetails' })

module.exports = mongoose.model('clearingPoProductDetails', clearingPoProductDetails);