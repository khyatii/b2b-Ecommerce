...
var multiplePoProductDetails = mongoose.Schema({

    orderNumber: { type: String, default: null },
    multiplePoId: { type: Schema.Types.ObjectId, ref: 'multiplePo' },
...
}, { collection: 'multiplePoProductDetails' })

module.exports = mongoose.model('multiplePoProductDetails', multiplePoProductDetails);
