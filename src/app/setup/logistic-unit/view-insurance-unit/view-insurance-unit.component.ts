...
@Component({
	selector: 'app-view-insurance-unit',
	templateUrl: './view-insurance-unit.component.html',
	styleUrls: ['./view-insurance-unit.component.css']
})
export class ViewInsuranceUnitComponent implements OnInit {
